                ...
                <form method="post" action="/auth/register">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-3 mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="checkShowPassword1"
                                onclick="showHide('inputPassword1')">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="inputPassword2" name="confirm_password"
                            required>
                        <div class="mt-3 mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="checkShowPassword2"
                                onclick="showHide('inputPassword2')">
                            <label class="form-check-label" for="checkShowPassword2">Show Confirm Password</label>
                        </div>
                    </div>
                    <div class="clear"></div>
                    <p class="mt-3 text-small text-secondary">People who use our services may upload your contact
                        information to Nikky. <a href="#">Learn more</a></p>

                    <p class="text-small text-secondary">By clicking Register, you agree to our Terms , <a
                            href="#">Privacy Policy</a> and <a href="#">Cookie Policy</a> . You will receive
                        an SMS Notification from us and can stop at any time.</p>
